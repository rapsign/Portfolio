...
const [formData, setFormData] = useState({
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_kwfmywq', 'template_npmngq3', templateParams, 'JEpzkXhbxoP-57CAT')
      .then((response) => {
    ...
    return (
        <section id="contact" className="flex flex-col items-center justify-center mb-10">
      ...
      className="w-full p-6 px-12 text-center lg:text-left sm:text-center">
        <h1 className="text-4xl font-bold mb-3 text-cyan-400">Feel Free To Contact Me</h1>
        <p className="text-lg">
      ...
      href="https://wa.me/6289632931696" target="_blank" rel="noopener noreferrer">
        <Card className={`mt-6 group w-full  border-b-4 border-cyan-400 hover:shadow-xl ${cardBgColor}`}>
          <CardBody>
            <div className="grid grid-cols-3">
              ...
              <div className="col-span-2 flex flex-col items-start justify-start">
                ...
                <Typography  className={`mb-2 ${textColor}`}>+62 89632931696</Typography>
      ...
      href="https://mail.google.com/mail/u/0/?fs=1&to=renaldiprayuda11@gmail.com&su=SUBJECT&body=Your+Messages&tf=cm" target="_blank" rel="noopener noreferrer" className="w-full">
        <Card className={`mt-6 group w-full border-b-4 border-cyan-400 hover:shadow-xl ${cardBgColor}`}>
          <CardBody>
            <div className="grid grid-cols-3">
              <motion.div
              ...
              <div className="col-span-2 flex flex-col items-start justify-start">
                ...
                <Typography  className={`mb-2 ${textColor}`}>renaldiprayuda11@gmail.com</Typography>
                <Typography className="flex items-start gap-2 font-bold text-cyan-400">
                  Send Me A Message
      ...
      href="https://t.me/+6289632931696" target="_blank" rel="noopener noreferrer" className="w-full">
        <Card className={`mt-6 group w-full border-b-4 border-cyan-400 hover:shadow-xl ${cardBgColor}`}>
          <CardBody>
            <div className="grid grid-cols-3">
              <motion.div
