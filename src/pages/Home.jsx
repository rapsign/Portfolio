...
const Home = ({ isDarkMode, toggleDarkMode }) => {
    ...
    return (
        <section id="home" className={`min-h-screen flex items-center justify-center ${isDarkMode ? 'bg-[#353845]' : 'bg-gray-100'}`}>
            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="col-span-1 m-5 flex justify-center items-center p-6">
                    <div className="">
                        <h4 className={`text-4xl font-medium ${textColor}`}>HI, WELCOME</h4>
                        <h1 className={`text-9xl font-bold ${textColor}`}>I'M <span className={`text-9xl font-bold ${highlightColor}`}>ALDI</span></h1>
                        <h1 className={`text-2xl font-medium ${textColor} mb-4`}>JUNIOR WEB DEVELOPER</h1>
                        ...
                        <Button href="your-cv-link.pdf" target="_blank" className={`flex items-center gap-3 bg-cyan-400 text-[#3a3a3c] ${hoverColor}`}>
                        <svg
